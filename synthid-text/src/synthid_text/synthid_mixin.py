...
DEFAULT_WATERMARKING_CONFIG = immutabledict.immutabledict({
    "ngram_len": 2,  # This corresponds to H=1 context window size in the paper.
    "keys": [654, 400, 836, 123, 340, 443, 597, 160], 
    # [654, 400, 836, 123, 340, 443, 597, 160, 57, 29, 590, 639, 13, 715, 468, 990, 966, 226, 324, 585, 118, 504, 421, 521, 129, 669, 732, 225, 90, 960],
    "num_leaves": 7,
...
class SynthIDMistralForCausalLM(
    SynthIDSparseTopKMixin, transformers.MistralForCausalLM
):
  pass
